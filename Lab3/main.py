...
def main(msg, type):
    if type == 0:
        encrypted_list = []
        for i in slice_msg(msg):
            bin_mess, bin_key = to_binary(i), to_binary(KEY)
...
if __name__ == '__main__':
    while True:
        main(input('Введіть повідомлення: '), int(
            input('Вибір (0 - шифрування, 1 - дешифрування): ')))